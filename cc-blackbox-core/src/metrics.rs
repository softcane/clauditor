...
impl CcBlackboxMetrics {
    fn register() -> Self {
        ...
        Self {
            ...
            .expect("register cc_blackbox_mcp_events_total"),
            skill_events_total: register_int_counter_vec!(
                opts!(
                    "cc_blackbox_skill_events_total",
                    "Skill lifecycle events observed or inferred by cc-blackbox."
                ),
